...
var settime = 15;
    ...
    function update(num) {
        ...
        document.getElementById('subButton').value = "返回列表（" + showthis + "）";
        if (showthis == 0) {
            next();
        }
    }
  ...
  <tr>
    <td align="center" valign="top"> 
      <table border="0" cellpadding="0" cellspacing="0"  style="width:60%;margin-top:110px;">
        <tr> 
          <td rowspan="2" align="left" valign="top" style="width:105px;"><img src="../images/common/right_icon.png" width="93" height="94"></td>
          <td class="text-tit" align="left">
				${msg}
           </td>
        </tr>
        <tr> 
          <td class="text1">请点击按钮，返回操作页面。</td>
        </tr>
        <tr> 
          <td class="end-l">&nbsp; </td>
          <td class="end-r"><input name="subButton" id="subButton" type="button" class="error-btn" value="返回列表" onclick="returnList()"></td>
        </tr>
      </table></td>
  </tr>
</table>
