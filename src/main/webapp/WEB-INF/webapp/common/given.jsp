...
$(document).ready(function() {
	$('#saveBtn').click(function(){
		$("form").attr("action","../common/updImg.shtml");
		$("form").submit();
	});
});
</script>
		...
		<tr>
			...
			<td valign="top" background="../images/system/content-bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td height="31"><div class="titlebt">二维码配置</div></td>
					</tr>
				</table>
			</td>
						...
						<tr>
							<td valign="top" colspan="4">
								<table width="98%" border="0"
									...
									<tr>
										<td class="left_txt">当前位置：二维码配置</td>
									</tr>
									<tr>
								...
								<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
								    <input type="hidden" name="mid" value="${mid}">
									   <tr>
										...
										<tr>
											<td width="20%" height="30" align="left" class="left_txt2" style="padding-bottom: 10px;">
												<input type="file" class="queryfield" id="img" name="img"/>(240*125px)
												<br/><br/><img src="${img}" width="240px" height="125px;">
											</td>										
										</tr>
										<%-- <tr>									
											<img src="${img}" width="240px" height="125px;">
										</tr> --%>
